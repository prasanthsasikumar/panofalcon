...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-falcon-50 via-white to-falcon-100 flex flex-col">
      ...
      <nav className="bg-white/80 backdrop-blur-md border-b border-gray-200 sticky top-0 z-50">
        <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-4 flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <Link href="/upload" className="btn-primary text-sm sm:text-base px-3 py-1.5 sm:px-6 sm:py-2">
              Upload
            </Link>
            <UserMenu />
          </div>
      ...
      {/* Hero Section */}
      <main className="container mx-auto px-3 sm:px-4 py-10 sm:py-20 flex-grow">
        <div className="text-center max-w-4xl mx-auto">
          <div className="mb-6 sm:mb-8 inline-flex items-center justify-center w-16 h-16 sm:w-24 sm:h-24 bg-falcon-100 rounded-full">
            <svg className="w-8 h-8 sm:w-12 sm:h-12 text-falcon-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 px-4">
            <Link href="/upload" className="btn-primary text-base sm:text-lg px-6 sm:px-8 py-2.5 sm:py-3 w-full sm:w-auto text-center">
              Upload Panorama
            </Link>
            <Link href="/gallery" className="btn-secondary text-base sm:text-lg px-6 sm:px-8 py-2.5 sm:py-3 w-full sm:w-auto text-center">
              View Gallery
            </Link>
          </div>

          {/* Stats */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 mt-12 sm:mt-20 max-w-3xl mx-auto px-4">
            <div className="text-center">
              <div className="text-3xl sm:text-4xl font-bold text-falcon-600 mb-2">Unlimited</div>
              <div className="text-gray-600">Storage</div>
            </div>
            <div className="text-center">
              <div className="text-3xl sm:text-4xl font-bold text-falcon-600 mb-2">Instant</div>
              <div className="text-gray-600">Sharing</div>
            </div>
            <div className="text-center">
              <div className="text-3xl sm:text-4xl font-bold text-falcon-600 mb-2">100% Free</div>
        ...
        {/* Features */}
        <div className="mt-16 sm:mt-32 grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto px-4">
          <div className="bg-white rounded-xl p-6 sm:p-8 shadow-lg">
            ...
            <h3 className="text-lg sm:text-xl font-bold mb-2">Easy Upload</h3>
          ...
          <div className="bg-white rounded-xl p-6 sm:p-8 shadow-lg">
            ...
            <h3 className="text-lg sm:text-xl font-bold mb-2">Instant Sharing</h3>
            <p className="text-sm sm:text-base text-gray-600">
          ...
          <div className="bg-white rounded-xl p-6 sm:p-8 shadow-lg">
            ...
            <h3 className="text-lg sm:text-xl font-bold mb-2">Immersive Viewing</h3>
            <p className="text-sm sm:text-base text-gray-600">
      ...
      {/* Footer */}
      <footer className="mt-auto bg-gray-900 text-white py-8 sm:py-12">
