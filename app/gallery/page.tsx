    ...
    <div className="min-h-screen bg-gradient-to-br from-falcon-50 via-white to-falcon-100">
      ...
      <nav className="bg-white/80 backdrop-blur-md border-b border-gray-200 sticky top-0 z-50">
        <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-4 flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            <Link href="/gallery" className="text-sm sm:text-base text-falcon-600 font-medium">
              Gallery
            </Link>
      ...
      <main className="container mx-auto px-3 sm:px-4 py-6 sm:py-12">
        <div className="mb-8 sm:mb-12">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-2">Gallery</h1>
        ...
        {panoramas.length === 0 ? (
          <div className="text-center py-12 sm:py-20 px-4">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">No panoramas yet</h2>
            <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6">Be the first to share a 360° experience!</p>
              ...
              >
                <div className="relative aspect-video bg-gray-200 overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-3 sm:p-4">
                    <span className="text-white font-medium text-sm sm:text-base">View in 360°</span>
                  </div>
                </div>
